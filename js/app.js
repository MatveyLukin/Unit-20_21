...
document.querySelector(
  ".contacts-block"
).innerHTML += `<li><a href="tel:${data.phone}">${data.phone}</a></li>`;
document.querySelector(
  ".contacts-block"
).innerHTML += `<li><a href="mailto:${data.email}">${data.email}</a></li>`;
document.querySelector(
  ".contacts-block"
).innerHTML += `<li><a href="callto:${data.skype}">${data.skype}</a></li>`;
document.querySelector(
  ".contacts-block"
).innerHTML += `<li><a href="${data.linkedin}">${data.linkedin}</a></li>`;
